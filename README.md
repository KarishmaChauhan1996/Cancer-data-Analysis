...
- Using statistical methods, we’ll explore and answer critical healthcare questions:
...
- For each major analysis, we will draw clear, evidence-backed inferences
